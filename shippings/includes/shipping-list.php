...
<div class="page-border-box2 mb-3 mb-md-4 shipping-item">
    <div class="pbb2-inner d-flex">
        ...
        <div class="lt d-flex align-items-center">
            <!-- icon -->
            <div class="icon">
                <img src="../images/icons/free-shipping-icon.svg" alt="" class="img-fluid" height="55" width="55">
            </div>
...
<div class="page-border-box2 mb-3 mb-md-4 shipping-item">
    <div class="pbb2-inner d-flex">
        ...
        <div class="lt d-flex align-items-center">
            <!-- icon -->
            <div class="icon">
                <img src="../images/icons/flat-rate-icon.svg" alt="" class="img-fluid" height="55" width="55">
            </div>
