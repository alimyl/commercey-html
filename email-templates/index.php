            ...
            <div class="app-main-wrapper">
                <div class="amw_inner">
                    ...
                    <div class="app-main-content d-flex flex-column">
                        ...
                        <!-- content -->
                        <section id="app-email-templates" class="st-def-mar-TB">
                            <div class="container-fluid st-container">
                                <div class="app-email-templates">
                                    <!-- header -->
                                    <div class="app-header-wrapper d-flex mb-2">
                                        <p class="app-heading text-capitalize">Email templates</p>
                                    </div>
                                    ...
                                    <div class="app-content-container">
                                        <div class="app-card">
                                            <div class="app-card-content bg-white border st-border-light st-default-rounded-block mb-3">
                                                ...
                                                <!-- listting table -->
                                                <div class="st-listing-table email-templates-table table-responsive">
                                                    <?php
