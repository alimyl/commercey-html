                            ...
                            <div class="app-products__create-details">
                                ...
                                <div class="page-save-button-block d-flex align-items-center">
                                    ...
                                    <div class="back-button-wrapper st-line-height-0">
                                        <a class="text-decoration-none st-text-primary d-inline-flex align-items-center cursor-pointer st-fs-14 st-fw-600"
                                    ...
                                    <!-- save btn -->
                                    <button class="st-btn st-btn-primary ms-auto">
                                        <span>Save</span>
                                    </button>
                                </div>
                                ...
                                <div class="app-header-wrapper">
                                    <p class="app-heading text-capitalize heading-sm">Create Product</p>
                                    <p class="app-desc">
                                        Create a product.
                                    </p>
                                </div>
                                        ...
                                        <div class="pbb-inner">
                                            ...
                                            <div class="st-tabs-links">
                                                <div class="stl-inner">
                                                    <!-- link -->
                                                    <a href="#general_tab"
                                                        class="stl-link d-inline-flex align-items-center text-capitalize ">
                                                        <!-- <i class="feather-alert-circle icon cursor-pointer me-2"></i> -->
                                                        <span>general</span>
                                                    </a>

                                                    <!-- link -->
                                                    <a href="#attributes_tab"
                                                        class="stl-link d-inline-flex align-items-center text-capitalize">
                                                        <span>attributes</span>
                                                    </a>

                                                    <!-- link -->
                                                    <a href="#variations_tab"
                                                        class="stl-link d-inline-flex align-items-center text-capitalize">
                                                    ...
                                                    <!-- link -->
                                                    <a href="#purchasability_tab"
                                                        class="stl-link d-inline-flex align-items-center text-capitalize">
                                                        <span>Purchasability</span>
                                                    </a>

                                                    <!-- link -->
                                                    <a href="#related_products_tab"
                                                        class="stl-link d-inline-flex align-items-center text-capitalize">
                                                ...
                                                <div class="product-container">
                                                    <div class="pc-inner d-flex flex-wrap">
                                                        ...
                                                        <div class="pc-lt media-body">
                                                            ...
                                                            <?php
                                                                    include "./includes/form-components/related-products.php"
                                                                ?>
                                                        </div>
                                                        ...
                                                        <div class="pc-rt">
                                                            ...
                                                            <div class="page-border-box2">
                                                                <div class="pbb2-inner">
                                                                    <p
                                                                        class="box-heading st-fw-600 st-text-color2 mb-2">
                                                                        Pricing</p>
                                                                    ...
                                                                    <div class="st-form form-sm no-arrows">
                                                                        <label>
                                                                            Price
                                                                            <span
                                                                                class="required ms-1 st-fs-12">(required)</span>
                                                                        </label>
                                                                        <input type="number" class="form-control"
                                                                    ...
                                                                    <div class="st-form form-sm no-arrows mb-0">
                                                                        ...
                                                                        <input type="number" class="form-control"
                                                                            placeholder="Promo Price" id="promoPrice"
                                                                            name="promoPrice" value="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="page-border-box2">
                                                                <div class="pbb2-inner">
                                                                    ...
                                                                    <div class="st-form form-sm no-arrows">
                                                                        ...
                                                                        <input type="number" class="form-control"
                                                                            placeholder="Low Stock" id="lowStock"
                                                                            name="lowStock" value="">
                                                                    </div>
                                                            ...
                                                            <div class="page-border-box2 set-product-availability">
                                                                <div class="pbb2-inner">
                                                                    ...
                                                                    <label
                                                                        ...
                                                                        <span
                                                                            class="text ms-2 position-relative st-fs-13 st-fw-600 active">Enabled</span>
                                                                        <span
