    ...
    <tbody>
        <tr>
            ...
            <td class="column__ProductName">
                <a class="text-decoration-none hover-underline-link st-text-primary" href="http://localhost/VEZIRE/commercey-html/products/edit.php">Acacia Cutting Board</a>
            ...
            <td class="column__actions">
                <div class="d-flex justify-content-end">
                    <a 
                        href="http://localhost/VEZIRE/commercey-html/products/edit.php"
