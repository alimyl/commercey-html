            ...
            <div class="page-border-box2">
                <div class="pbb2-inner variation-options-view">
                    ...
                    <div class="btns mb-3 d-flex flex-wrap">
                        <a href="http://localhost/commercey-html/products/variations.php" class="st-btn st-btn-white-gray-outlined st-btn-sm d-flex align-items-center text-capitalize">
