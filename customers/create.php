                            ...
                            <div class="container-fluid st-container">
                                <div class="app-customers__create-details">
                                    ...
                                    <div class="page-save-button-block d-flex align-items-center">
                                        ...
                                        <div class="back-button-wrapper st-line-height-0">
                                            <a 
                                                ...
                                                href="https://mycommercey.com/commercey-html/customers/">
                                                <i class="feather feather-arrow-left icon me-1"></i>
                                                <span>Cancel and go back to customers</span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="app-header-wrapper mb-3">
                                        <p class="app-heading text-capitalize heading-sm">Create Customer</p>
                                        <p class="app-desc">
                                            Create a customer who will have access to different parts of your store. you can assign different customers different roles.
                                        </p>
                                    </div>
                        
                                    <!-- content -->
                                    <div class="app-card customer">
                                        <div class="app-card-content bg-white border st-default-rounded-block mb-3 pad-12-T pad-12-B ">
