            ...
            <div class="app-main-wrapper">
                <div class="amw_inner">
                    ...
                    <div class="app-main-content d-flex flex-column">
                        ...
                        <!-- content -->
                        <section id="app-product-types__create-details" class="st-def-mar-TB page-eorc-wrapper">
                            <div class="container-fluid st-container">
                                <div class="app-product-types__create-details">
                                    <!-- back or save -->
                                    <div class="page-save-button-block d-flex align-items-center">
                                        ...
                                        <div class="back-button-wrapper st-line-height-0">
                                            <a 
                                                ...
                                                href="http://localhost/VEZIRE/commercey-html/product-types/">
                                                <i class="feather feather-arrow-left icon me-1"></i>
                                                <span>Cancel and go back to product types</span>
                                            </a>
                                        </div>
                                        ...
                                        <button
                                            ...
                                            <span>Create Product Types</span>
                                        </button>
                                    </div>

                                    <!-- header -->
                                    <div class="app-header-wrapper mb-3">
                                        <p class="app-heading text-capitalize heading-sm">Create Product Types</p>
                                        <p class="app-desc">
