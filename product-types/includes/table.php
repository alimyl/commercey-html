...
<table class="mb-0 table">
    ...
    <tbody>
        <tr>
            ...
            <td class="column__AttributeName"><p class="">Material</p></td>

            <td class="column__Status"><p class="">Active</p></td>
            
            <td class="column__actions">
                <div class="d-flex justify-content-end">
                    <a 
                        href="https://mycommercey.com/commercey-html/product-types/edit.php"
