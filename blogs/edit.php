            ...
            <div class="app-main-wrapper">
                <div class="amw_inner">
                    ...
                    <div class="app-main-content d-flex flex-column">
                        ...
                        <!-- content -->
                        <section id="app-blogs__create-details" class="st-def-mar-TB page-eorc-wrapper">
                            <div class="container-fluid st-container">
                                <div class="app-blogs__create-details">
                                    <!-- back or save -->
                                    <div class="page-save-button-block d-flex align-items-center">
                                        ...
                                        <div class="back-button-wrapper st-line-height-0">
                                            <a 
                                                ...
                                                href="http://localhost/commercey-html/blogs/">
                                    ...
                                    <div class="app-header-wrapper mb-3">
                                        <p class="app-heading text-capitalize heading-sm">Edit blog</p>
                                        <p class="app-desc">
                                            Edit a blog for your products.
                                        </p>
                                    </div>
